...
@section('content')
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
		    	...
		    	@php $total += $addition->rate * $addition->validity * $addition->quantity * $addition->unitcost; @endphp
          @php $dtotal += $addition->total - $addition->total*$addition->discount/100; @endphp
            <tr>
              ...
              <td>{{$addition->validity}} month(s)</td>
    ...
    <div class="clearfix"></div>
   	...
   	<iframe id="invoiceDownload" style="display: none;" src="{{url('subPDF')}}?id={{$_GET['id']}}"></iframe>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
      	<label class="col-sm-12" for="">Currency</label><br>
			<div class="col-sm-12">
				<select name="currency" id="" class=" form-control col-sm-12">
        ...
        <div class="form-group row">
      	<label class="col-sm-12" for="">Dollar Rate</label><br>
			<div class="col-sm-12">
				<input type="text" class="form-control col-sm-12" name="rate" id="" value="1" placeholder="If Naira value or non converting Dollar value, put 1">
			</div>
      	</div>
      	<div class="form-group row">
        ...
        <div class="form-group row">
      	<label class="col-sm-12" for="">Validity Period</label><br>
			<div class="col-sm-12">
			<input type="text" class="form-control col-sm-12" name="validity" placeholder="Indicate by only number of months e.g 1" id="" required>
			</div>
      	</div>
      	<div class="form-group row">
...
$({
	...
	{
		$('#manageorg').load("{{url('organization')}}/modals/editSub?id="+id);
